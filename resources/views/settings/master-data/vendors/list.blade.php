    ...
    <div class="card-header">
        <div class="row">
            <div class="col">
                ...
                <strong>{{ __('form.vendor_list') }}</strong>
            </div>
            <div class="col">
                <a class="float-right btn btn-md btn-info" href="{{ route('setting.master-data.vendor.create') }}">
                    ...
                    <tr>                         
                        <td class="text-center text-nowrap">
                            <a class="btn btn-sm btn-primary mr-1 "
                                href="{{ route('setting.master-data.vendor.edit',['id' => $record->id ])}}" type="button">                                    

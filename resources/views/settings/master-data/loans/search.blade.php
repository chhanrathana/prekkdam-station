<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('setting.master-data.loan.index') }}" class="mt-2" id="frmSearch" method="GET">
            <div class="form-row">                
                ...
                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2 mb-1">
                    ...
                    <a href="{{route('setting.master-data.loan.index')}}" class="btn btn-warning mb-2">

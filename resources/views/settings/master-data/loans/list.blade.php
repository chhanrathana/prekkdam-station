<div class="card">
    <div class="card-header text-white bg-info">
        <div class="row">
            ...
            {{-- <div class="col">
                <a class="float-right btn btn-md btn-warning" href="{{ route('setting.master-data.loans.create') }}">
                    ...
                    <tr>
                        {{-- <td class="text-center text-nowrap"> --}}
                            {{-- <a class="btn btn-sm btn-primary mr-1 "
                                href="{{ route('setting.master-data.loans.edit',['id' => $record->id ])}}" type="button">                                    

                    ...
                    <table class="table table-bordered table-responsive-md">
                        <thead class="thead-primary">
                            <tr>
                                ...
                                <th class="text-center"><strong>SEX</strong></th>       
                                <th class="text-center"><strong>PHONE NUMBER 01</strong></th>      
                                <th class="text-center"><strong>PHONE NUMBER 02</strong></th>      
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('master-data.customer.edit',['id' => $item->id]) }}">Edit</a>
                                ...
                                <td>{{ $item->name_kh }}</td>
                                <td>{{ $item->name_en }}</td>    
                                <td>{{ $item->sex->name_kh??'' }}</td>                                
                                <td>{{ $item->phone_number_01 }}</td>                          
                                <td>{{ $item->phone_number_02 }}</td>                          
                                <td>{{ $item->address }}</td>                          

    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-6 form-group row">
                ...
                <label class="col-6 col-sm-8 col-form-label font-weight-bold">{{ number_format($record->principal_amount) }}</label>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-6 form-group row">
                ...
                <label class="col-6 col-sm-8 col-form-label font-weight-bold">{{ number_format($record->balance_amount) }}</label>
            </div>
        </div>
    </div>
</div>
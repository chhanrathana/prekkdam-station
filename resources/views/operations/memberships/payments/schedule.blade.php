                ...
                <tbody>
                    @foreach ($deposit->payments as $payment)                       
                        <tr>                                                          
                            ...
                            <td class="text-right text-nowrap text-success">{{ number_format($payment->deposit_amount, 2)}} KHR</td>  
                            <td class="text-right text-nowrap text-success">{{ number_format($payment->interest_amount,2)}} KHR</td>
                            <td class="text-right text-nowrap text-danger">{{ number_format($payment->withdraw_amount,2)}} KHR</td>                                                        

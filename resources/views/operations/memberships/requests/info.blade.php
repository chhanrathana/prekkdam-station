<div class="card">
    <div class="card-header text-white bg-info">
        ...
        <strong>{{ __('form.record_info') }}</strong>
    </div>
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-6 form-group row">
                ...
                <label class="col-6 col-sm-8 col-form-label font-weight-bold">{{ $record->type->name_kh??null }}</label>
            </div>

            <div class="col-12 col-sm-6 col-md-6 form-group row">
                <label class="col-6 col-sm-4 col-form-label">{{ __('form.record_code') }}</label>
                <label class="col-6 col-sm-8 col-form-label font-weight-bold">{{ $record->code }}</label>
            </div>
            
            <div class="col-12 col-sm-6 col-md-6 form-group row">
                <label class="col-6 col-sm-4 col-form-label">{{ __('form.record_amount') }}</label>

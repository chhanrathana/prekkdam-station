<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-sm-4">                
                ...
                <input
                    ...
                    value="{{ number_format($record->principal_amount) }}"
                >
            ...
            <div class="form-group col-sm-4">
                ...
                <input
                    ...
                    placeholder="10000000"
                    disabled
                    value="{{ number_format($record->interest_amount) }}"
                >
            ...
            <div class="form-group col-sm-4">
                ...
                <input
                    ...
                    placeholder="10000000"
                    autocomplete="off"
                    value="{{ $record->withdraw_amount??0 }}"
                >
            ...
            <div class="form-group col-sm-4">
                ...
                <input
                    ...
                    placeholder="10000000"
                    autocomplete="off"     
                    {{ ($record->deposit->deposit_type_id??null) == 'deposit'?'readonly':'' }}
                    value="{{ $record->deposit_amount??0 }}"
                >
            ...
            <div class="form-group col-sm-4">
                ...
                <input
                    ...
                    placeholder="10000000"
                    disabled
                    value="{{ number_format($record->balance_amount) }}"
                >
      ...
      <div class="card-footer">
        <div class="row">
            <div class="col">
                <a class="btn btn-warning float-left" href="{{ route('operation.deposit.payment.index')}}">

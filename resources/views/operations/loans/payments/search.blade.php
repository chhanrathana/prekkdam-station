<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('operation.loan.payment.index') }}" class="mt-2" id="frmSearch" method="GET">
            <div class="form-row">                
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-1">
                    <input
                        ...
                        name="loan_code"
                        maxlength="50"
                        value="{{ request('loan_code') }}"
                        placeholder="{{ __('form.loan_code') }}">
                </div>
                ...
                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2 mb-1">
                    ...
                    <a href="{{route('operation.loan.payment.index')}}" class="btn btn-warning mb-2">

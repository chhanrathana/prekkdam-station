                    ...
                    [
                        ...
                        'childs' => [
                            [
                                'label' => 'ប្រចាំខែ',
                                'permission' => '#',
                                'url' => 'report.sale.monthly.index',
                                'active_url' => 'report/sale/monthly/*',
                                'url_id'        => 'URL078',
                                'active'        => 1,
                            ],
                            [
                                'label' => 'ប្រចាំថ្ងៃ',
                                'permission' => '#',
                                'url' => 'report.sale.daily.index',
                                'active_url' => 'report/sale/daily/*',
                                'url_id'        => 'URL078',
                                'active'        => 1,
                            ],                                                                 
                        ],
                    ...
                    [
                        ...
                        'childs' => [
                            [
                                'label' => 'ស្តុក',
                                'permission' => '#',
                                'url' => 'report.purchase.stock.index',
                                'active_url' => 'report/purchase/stock/*',
                                'url_id'        => 'URL078',
                                'active'        => 1,
                            ],
                            [
                                'label' => 'ប្រចាំខែ',
                                'permission' => '#',
                                'url' => 'report.purchase.monthly.index',
                                'active_url' => 'report/purchase/monthly/*',
                                'url_id'        => 'URL078',
                                'active'        => 1,
                            ],
                            [
                                'label' => 'ប្រចាំថ្ងៃ',
                                'permission' => '#',
                                'url' => 'report.purchase.daily.index',
                                'active_url' => 'report/purchase/daily/*',
                                'url_id'        => 'URL078',
                                'active'        => 1,
                            ]      
                        ],

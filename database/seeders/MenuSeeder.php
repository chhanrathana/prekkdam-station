                    ...
                    [
                        ...
                        'childs'        => [
                            [
                                'label' => 'បញ្ចូលថ្មី',
                                'permission' => 'purchase.daily-create',
                                'url' => 'operation.account-receivable.request.create',
                                'active_url' => 'operation/account-receivable/request/create/*',
                                'url_id'        => 'URL012',
                                'active'        => 1,
                            ],
                            [
                                'label' => 'តារាង',
                                'permission' => 'purchase-list',
                                'url' => 'operation.account-receivable.request.index',
                                'active_url' => 'operation/account-receivable/request/list/*',
                                'url_id' => 'URL021',
                                'active' => 1,
                            ],
                        ],
                    ...
                    [
                        ...
                        'childs'        => [
                            [
                                'label' => 'បញ្ចូលថ្មី',
                                'permission' => 'purchase.daily-create',
                                'url' => 'operation.account-payable.request.create',
                                'active_url' => 'operation/account-payable/request/create/*',
                                'url_id' => 'URL012',
                                'active' => 1,
                            ],
                            [
                                'label' => 'តារាង',
                                'permission' => 'purchase-list',
                                'url' => 'operation.account-payable.request.index',
                                'active_url' => 'operation/account-payable/request/list/*',
                                'url_id'        => 'URL021',
                                'active'        => 1,
                            ],
                        ],

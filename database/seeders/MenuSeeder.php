                ...
                'data'  => [
                    [
                        ...
                        'childs'        => [                     
                            ...
                            //     'url' => 'operation.loan.payment.index',
                            //     'active_url' => 'operation/loan/payment/*',
                            //     'url_id'        => 'URL031',
                            //     'active'        => 1,
                            // ],
                            [
                                ...
                                'url' => 'operation.loan.request.create',
                                'active_url' => 'operation/loan/request/create/*',
                                'url_id'        => 'URL012',
                                'active'        => 1,
                            ],
                            [
                                ...
                                'url' => 'operation.loan.request.index',
                                'active_url' => 'operation/loan/request/list/*',
                                'url_id'        => 'URL021',
                                'active'        => 1,
                            ],
                        ],
